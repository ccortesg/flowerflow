...
- [x] 2026-08-18 MST — Revalidación solicitada antes de publicación Git: los tres PDF v1.1 siguen siendo legibles, A4, no cifrados y conservan sus hashes esperados; extracción textual y render visual confirman versión, responsable y cierre. La búsqueda global demostró que configuración, migración y superficies vigentes consumen v1.1. Se corrigió `scripts/publish_authorized_assets.sh` para validar directamente esos tres artefactos en `public/documentos/2026` y evitar que una publicación de activos vuelva a copiar v1.0 desde `formatos/`.
