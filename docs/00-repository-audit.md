...
> **Actualización vigente (2026-08-17):** este documento conserva únicamente la fotografía de la baseline inicial. El estado actual por módulo/rol está en `docs/16-project-status-by-module-and-role-2026-08-17.md`; las afirmaciones “no existe” de este informe no describen el checkout actual.
