...
> **ADR-0016 — 2026-08-26, local/test:** Asignaciones/Evaluaciones incorporan filtros homogéneos por propuesta y la exportación administrativa añade `current_revisions_v1`, una fila por juez y detalle de rubros de la revisión vigente, sin reemplazar `all_revisions_v1`. No hay migración, ruta, permiso, dependencia, worker, stage, commit, push, deploy o producción. Evidencia y gates se registran en el informe 33; se conserva `NO-GO RELEASE/PRODUCTION — OWNER_OVERRIDE / LEGAL_RECONCILIATION_REQUIRED`.
