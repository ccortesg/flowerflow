...
> **Adenda UX ADR-0017 — 2026-09-08, local/test:** el landing invita a votar con «¡La gente elige!», título Georgia, fondo crema, verde oscuro y urna ilustrada a partir del flyer. El botón precede a la imagen en móvil; encabezado y cierre abren el mismo modal Bootstrap. El formulario carga en la primera apertura y conserva su instancia. Cierre, título y «Abrir en Google» permanecen visibles; se informa el requisito de sesión de Google. Sin JavaScript, los accesos son enlaces al formulario. Se conservan las secciones informativas, PDF y acceso a cuentas. Evidencia y límites en [informe 34](34-public-voting-integration-2026-09-08.md) y [QA](design-qa.md); no representa despliegue ni validación con cuenta Google.
...
> **Adenda UX M6A — 2026-08-24:** el juez dispone de shell propio con Inicio, Mis asignaciones, Cuenta y seguridad y Cerrar sesión; sidebar desktop y offcanvas móvil accesible. Dashboard/listado muestran métricas, plazo, paquete, progreso dinámico y CTA contextual. En detalle, “Iniciar/Continuar evaluación” es la acción verde primaria y “Declarar conflicto” una acción secundaria visible; el texto pide declarar conflicto antes de evaluar. La cuenta ofrece contraseña y 2FA opcional sin campos de participante. El panel admin explica selección manual por pasos, carga sólo informativa, cero mínimos/máximos y notificación opcional.

> **Adenda UX de Notificaciones — 2026-08-23, local/test:** el acceso aparece inmediatamente después de `Paquetes ciegos` y antes de `Cuenta y seguridad`, sólo para admin exacto autorizado y con flag activo. La tabla paginada de 25 filtra por estado, tipo, fecha y atención; muestra generación, tipo, destinatario enmascarado, referencia técnica, estado, intentos, actualización y acción. El detalle presenta una línea de tiempo sin contenido sensible. `queued`, `failed` y `unknown` ofrecen respectivamente Procesar, Reintentar y Reenviar con riesgo; el último exige advertencia adicional. `sent` se rotula `Aceptado por el servidor de correo`, nunca `Entregado`.
