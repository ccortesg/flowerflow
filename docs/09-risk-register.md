...
| R75 | Diseño presentado como implementación | Bajo documental controlado | M1–M6 están conformes local/test; M7–M10 no están implementados | Mantener estado por milestone y no atribuir M1–M6 locales a producción |
