...
@section('content')
    ...
    <p style="margin:0 0 24px;">Se creó para ti una cuenta de juez en Flower Flow. Usa este enlace temporal de un solo uso para establecer una contraseña propia y verificar tu correo en la misma operación.</p>
    ...
    <p style="margin:0 0 12px;color:#4b625b;font-size:14px;">El enlace vence el {{ $expiresAt }} (hora de Hermosillo). No recibirás una segunda solicitud de verificación. La autenticación en dos pasos es opcional.</p>
