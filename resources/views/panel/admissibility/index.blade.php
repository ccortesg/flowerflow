...
<form method="GET" class="card ff-card p-3 my-4" aria-label="Filtros de admisibilidad">
  <div class="row g-3 align-items-end">
    ...
    <div class="col-sm-6 col-xl-2"><label class="form-label" for="folio">Folio o ID de propuesta</label><input class="form-control" id="folio" name="folio" maxlength="64" value="{{ request('folio') }}"></div>
